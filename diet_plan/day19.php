 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(255, 217, 102)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">1 Apple</li>
  <li style="font-size:150%;">1 Yogurt</li>
</ul>   
    </div>
  </div>
   <p><br></p>
  ...
  <div class="card" style="width:100%; background-color:rgb(255, 51, 51)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Cooked or baked beans</li>
 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(102, 255, 217)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Smoothie or low fat yogurt</li>
  <li style="font-size:150%;">Cup of milk</li>
</ul>   
    </div>
  </div>
   <p><br></p>
