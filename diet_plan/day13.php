...
<div class="container-fluid">
  ...
  <li style="font-size:150%;">1 cup of fresh fruits</li>
</ul>   
    </div>
  </div>
   <p><br></p>
 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(255, 217, 102)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Nuts (no salt added)</li>
  ...
  <div class="card" style="width:100%; background-color:rgb(255, 51, 51)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Tuna Sandwich</li>
  <li style="font-size:150%;">Vegetable and fruit salad</li>
</ul>   
    </div>
  </div>
   <p><br></p>
