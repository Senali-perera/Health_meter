...
<div class="container-fluid">
  ...
  <li style="font-size:150%;">Egg white omelete</li>
</ul>   
    </div>
  </div>
   <p><br></p>
 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(255, 217, 102)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Popcorn – air-popped or fat-free microwave</li>
   <li style="font-size:150%;">Mashed potatoes</li>
</ul>   
    </div>
  </div>
   <p><br></p>
  ...
  <div class="card" style="width:100%; background-color:rgb(255, 51, 51)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Any grilled or boiled seafoods</li>
  <li style="font-size:150%;">Cooked or boiled vegetables</li>
</ul>   
    </div>
  </div>
   <p><br></p>
 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(102, 255, 217)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Baked or boiled potatoes</li>
  <li style="font-size:150%;">Any grilled or boiled lean meats</li>
</ul>   
    </div>
  </div>
   <p><br></p>
