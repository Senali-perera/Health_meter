...
<div class="container-fluid">
  ...
  <li style="font-size:150%;">Whole grain cereal</li>
</ul>   
    </div>
  </div>
   <p><br></p>
 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(255, 217, 102)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Cheese and Fruit</li>
  ...
  <li style="font-size:150%;">Some blueberries, strawberries, raspberries or blackberries</li>
</ul>   
    </div>
  </div>
   <p><br></p>
 ...
 <div class="col-sm-6" >
  <div class="card" style="width:100%; background-color: rgb(102, 255, 217)">    
    <div class="card-body">
      ...
      <p class="card-text"></p>
	  <ul style="list-style-type:circle;">
  <li style="font-size:150%;">Cooked or boiled corn</li>
  <li style="font-size:150%;">Chicken salad (with some vegetables)</li>
</ul>   
    </div>
  </div>
   <p><br></p>
